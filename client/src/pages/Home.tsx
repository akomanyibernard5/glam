...
const allProducts: (Product & { category: string })[] = [
  ...
  { id: "d1", name: "Midi Dress", price: 79, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "d2", name: "Maxi Dress", price: 89, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "d3", name: "Bodycon Dress", price: 59, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "d4", name: "Wrap Dress", price: 75, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  
  
  { id: "t1", name: "Silk Blouse", price: 65, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "t2", name: "Crop Top", price: 35, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "t3", name: "Cardigan", price: 75, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  
  
  { id: "bt1", name: "High-Waist Jeans", price: 69, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "bt2", name: "Midi Skirt", price: 54, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  
  
  { id: "b1", name: "Ladies Dressing Bag", price: 110, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "b2", name: "Ladies Chain Handbag", price: 44, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "b3", name: "Ladies Designer Tote", price: 89, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "b4", name: "Ladies Evening Clutch", price: 65, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "b5", name: "Ladies Shoulder Purse", price: 95, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  
  
  { id: "j1", name: "Gold Necklace", price: 35, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "j2", name: "Pearl Earrings", price: 25, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "j3", name: "Silver Bracelet", price: 40, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "j4", name: "Ring Set", price: 30, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "j5", name: "Diamond Earrings", price: 120, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  
  
  { id: "w1", name: "Ladies Curly Lace Front Wig", price: 150, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "w2", name: "Ladies Sleek Bob Wig", price: 120, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "w3", name: "Ladies Long Wavy Wig", price: 180, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "w4", name: "Ladies Pixie Cut Wig", price: 95, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
  { id: "w5", name: "Ladies Braided Wig", price: 200, image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
];
      ...
      <section className="relative overflow-hidden rounded-xl border bg-gradient-to-tr from-rose-50 via-white to-rose-100">
        <div className="grid gap-3 p-4 md:grid-cols-2 md:p-6">
          ...
          <div className="relative">
            <LazyImage
              src="https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
          ...
          {[
            {
              key: "clothing",
              title: "Clothes",
              img: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=1200&auto=format&fit=crop"fit=crop"fit=crop",
            },
            {
              key: "bags",
              title: "Bags",
