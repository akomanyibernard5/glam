...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.email === "oseibernard401@gmail.com" && formData.password === "admin1234") {
            ...
            >
              {error && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-red-500/20 border border-red-500/50 rounded-xl p-3 text-red-300 text-sm text-center"
                >
                  {error}
                </motion.div>
              )}
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white py-4 rounded-2xl font-bold text-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 flex items-center justify-center gap-2 group mt-8 disabled:opacity-50 disabled:cursor-not-allowed"
              >
